...
(function (HarryPotter) {
    ...
    function drawCanvas() {
        ...
        drawBook(180, 500, "#4169E1", "#4169E1");
    }
    function drawCauldron(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
    ...
    function drawRecipeList(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
        crc2.fillStyle = _fillColor;
        crc2.strokeStyle = _strokeColor;
        crc2.moveTo(_x, _y);
    ...
    function drawRecipe1(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
        crc2.fillStyle = _fillColor;
        crc2.strokeStyle = _strokeColor;
    ...
    function drawRecipe2(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
        crc2.fillStyle = _fillColor;
        crc2.strokeStyle = _strokeColor;
        crc2.font = "30px 'Great Vibes', cursive";
    ...
    function drawRecipe3(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
        crc2.fillStyle = _fillColor;
        crc2.strokeStyle = _strokeColor;
        crc2.font = "30px 'Great Vibes', cursive";
    ...
    function drawRecipe4(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
        crc2.fillStyle = _fillColor;
        crc2.strokeStyle = _strokeColor;
        crc2.font = "30px 'Great Vibes', cursive";
    ...
    function drawRecipe5(_x, _y, _strokeColor, _fillColor) {
        crc2.beginPath();
        crc2.fillStyle = _fillColor;
        crc2.strokeStyle = _strokeColor;
        crc2.font = "30px 'Great Vibes', cursive";
