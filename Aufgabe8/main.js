...
(function (L8_Inheritance) {
    ...
    function drawCanvas() {
        //Himmel
        L8_Inheritance.crc2.fillStyle = "#131354";
        L8_Inheritance.crc2.fillRect(0, 0, canvas.width, canvas.height);
        //Wiese
        L8_Inheritance.crc2.fillStyle = "#54B863";
        L8_Inheritance.crc2.fillRect(0, 250, 600, 250);
        ...
        for (let i = 0; i < nFirefly; i++) {
            let f = new L8_Inheritance.Firefly(xJar, yJar);
            fireflies[i] = f;
        }
        //Blumen
        for (let i = 0; i < nFlowers; i++) {
            let d = new L8_Inheritance.Dandelion(100, 350);
            flowers.push(d);
        }
        background = L8_Inheritance.crc2.getImageData(0, 0, 600, 450);
    }
    //Animation
    function animation() {
        L8_Inheritance.crc2.putImageData(background, 0, 0);
    ...
    function drawJar(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.fillRect(_x, _y, 30, 40);
    ...
    function drawLid(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.lineTo(_x + 15, _y + 25);
        L8_Inheritance.crc2.lineWidth = 2;
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawMoon(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.arc(_x, _y, 25, 0 * Math.PI, 2 * Math.PI);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawSmallMountain(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.lineTo(_x + 50, _y - 75);
        L8_Inheritance.crc2.lineTo(_x + 100, _y + 0);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawMiddleMountain(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.lineTo(_x + 100, _y - 150);
        L8_Inheritance.crc2.lineTo(_x + 200, _y + 0);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawBigMountain(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.lineTo(_x + 150, _y - 200);
        L8_Inheritance.crc2.lineTo(_x + 300, _y + 0);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawCloud(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.beginPath();
        L8_Inheritance.crc2.arc(_x - 30, _y + 1, 20, 0, 2 * Math.PI);
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.beginPath();
        L8_Inheritance.crc2.arc(_x - 25, _y + 15, 20, 0, 2 * Math.PI);
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.beginPath();
        L8_Inheritance.crc2.arc(_x, _y + 20, 25, 0, 2 * Math.PI);
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.beginPath();
        L8_Inheritance.crc2.arc(_x + 25, _y + 15, 25, 0, 2 * Math.PI);
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.arc(_x + 30, _y + 1, 25, 0, 2 * Math.PI);
        L8_Inheritance.crc2.fill();
    }
    function drawPond(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.quadraticCurveTo(350, 250, 150, 350);
        L8_Inheritance.crc2.quadraticCurveTo(200, 450, 400, 350);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawLilypad(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.arc(_x, _y, 20, 0 * Math.PI, 1.8 * Math.PI);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawWaterlily(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.arc(_x, _y, 10, -0.2 * Math.PI, 1.2 * Math.PI);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawDandelion(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.arc(_x, _y, 10, 0 * Math.PI, 2 * Math.PI);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
        L8_Inheritance.crc2.fill();
    ...
    function drawStalk(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.lineTo(_x + 0, _y + 50);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
    }
    ...
    function drawPetal(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.arc(_x, _y, 20, 1.1 * Math.PI, 1.9 * Math.PI, true);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
    }
    function drawPinkfan(_x, _y, _strokeColor, _fillColor) {
        ...
        L8_Inheritance.crc2.strokeStyle = _strokeColor;
        L8_Inheritance.crc2.moveTo(_x, _y);
        L8_Inheritance.crc2.arc(_x, _y, 25, 1.1 * Math.PI, 1.9 * Math.PI, false);
        L8_Inheritance.crc2.stroke();
        L8_Inheritance.crc2.fill();
        L8_Inheritance.crc2.closePath();
    }
...
})(L8_Inheritance || (L8_Inheritance = {})); // Namespace Ende
